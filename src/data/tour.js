...
export default [
    {
        ...
        body: <FormattedMessage id="tour.highlight3.text" defaultMessage="Plan your projects with the trustee Gantt chart and define dependencies, constraints and milestones for your tasks. Its connection with your back office systems makes painstaking work such as billing and timesheet administration a doddle." />,
        img: gantt,
        ...
        body: <FormattedMessage id="tour.highlight2.text" defaultMessage="Dime.Scheduler allows you to define the meaning of capacity. It can be whatever you want it to be. Whether it is time, loading volume trucks, seats in a van, Dime.Scheduler's flexible pivot grid and capacity mechanism enables you to report on the relevant capacity parameters." />,
        img: capacity,
        alignContentLeft: true
    }, {
        ...
        body: <FormattedMessage id="tour.highlight6.text" defaultMessage="Define requirements for your tasks such as skills, languages, certifications, region, and match resources that are eligible to carry out those tasks. " />,
        img: resourceFilters,
        alignContentLeft: false
    }, {
        title: <FormattedMessage id="tour.highlight4.title" defaultMessage="Visualize your resources and tasks on the map" />,
        intro: <FormattedMessage id="tour.highlight4.subtitle" defaultMessage="Locate your work and resources and create an efficient schedule accordingly" />,
        body: <FormattedMessage id="tour.highlight4.text" defaultMessage="Assemble trips for your fleet, find a qualified technician that is nearby the site of a customer for an urgent case, whatever your business case is, the connected map is almost a guarantee to help improve your resources' schedules." />,
        img: map,
        alignContentLeft: true
    }, {

        title: <FormattedMessage id="tour.highlight7.title" defaultMessage="Integrated with your technological landscape" />,
        intro: <FormattedMessage id="tour.highlight7.subtitle" defaultMessage="Connect to any application and equip your workforce a seamless and integrated toolkit." />,
        ...
        title: <FormattedMessage id="tour.highlight5.title" defaultMessage="Personalized" />,
        ...
        body: <FormattedMessage id="tour.highlight5.text" defaultMessage="You are in total control. Choose what components you want see in the planning with user profiles. Select which data you want to see with layout filters, sorting, grouping and column selection. Configure and customize the application to automate your planning processes." />,
        img: personalize,
        alignContentLeft: true
    }
]