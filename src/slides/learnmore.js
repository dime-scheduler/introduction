        ...
        <section>
            <div className="wrap">
                <div className="content-left">
                    ...
                    <p>More videos are available on <a href="https://www.youtube.com/user/DimenicsTV" target="_blank"><FontAwesomeIcon icon={faYoutube} /></a> or check out the docs <a href="https://docs.dimescheduler.com" target="_blank"><FontAwesomeIcon icon={faBookOpen} /></a> .</p>
                </div>
