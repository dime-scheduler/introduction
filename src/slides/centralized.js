  ...
  return (
    <section className="bg-gradient-v">
      ...
      <div className="wrap size-60">
        ...
        <h4><FormattedMessage id="centralized.content" defaultMessage="Say goodbye to duplicate bookings, delays, missing materials, incomplete timesheets, incorrect invoices, unfinished jobs, no-shows, high employee turnover and low morale, unnecessary overtime, excessive status meetings and so many other subtle annoyances that hinder your company's growth." /></h4>
      </div>
    </section>
  )
}